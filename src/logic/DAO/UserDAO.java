...
public class UserDAO {
    ...
    private static final String SQL_INSERT =
            "INSERT INTO user (personnel_number, account_id, username, full_name, phone, created_at, updated_at, deleted_at) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";

    private static final String SQL_UPDATE =
            "UPDATE user SET account_id = ?, username = ?, full_name = ?, phone = ?, " +
                    "created_at = ?, updated_at = ?, deleted_at = ? " +
                    "WHERE personnel_number = ?";

    private static final String SQL_DELETE =
            "DELETE FROM user WHERE personnel_number = ?";

    private static final String SQL_SELECT_BY_ID =
            "SELECT * FROM user WHERE personnel_number = ?";
