...
/**
 * Carga de configuración de BD desde classpath:
 *  - resources/db.properties (base)
 *  - resources/db-<app.env>.properties (opcional, si app.env existe)
 *  - Overrides por System Properties: DB_URL, DB_USER, DB_PASS
 *  - Overrides por Variables de Entorno: DB_URL, DB_USER, DB_PASS
 *
 * Prioridad (mayor a menor): System Props > Env Vars > db-<env>.properties > db.properties
 */
public final class ConfigLoader {
    ...
    public static void load() {
        ...
        // 2) Si hay perfil (app.env), cargar db-<env>.properties y superponer
    ...
    /** Devuelve una copia inmutable con fines de diagnóstico. */
